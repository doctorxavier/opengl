...
static GLfloat slanted[] = {1.0, 1.0, 1.0, 0.8};
...
void accFrustum(GLdouble, GLdouble, GLdouble, GLdouble, GLdouble, GLdouble, GLdouble, 
    GLdouble, GLdouble, GLdouble, GLdouble);
void accPerspective(GLdouble, GLdouble, GLdouble, GLdouble, GLdouble, GLdouble, 
